   ...
   Begin MSComctlLib.StatusBar stBar 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Alignment       =   2
            Enabled         =   0   'False
            TextSave        =   "鍵盤上 Caps Lock 的狀態"
         EndProperty
         BeginProperty Panel2 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Style           =   3
            Enabled         =   0   'False
            TextSave        =   "鍵盤上的 Insert 鍵狀態"
         EndProperty
...
Private Sub cjEdt_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    stBar.Panels("Msg").Text = "座標：" & Round(ScaleX(x, vbPixels, vbCentimeters), 1) & " cm  " & Round(ScaleY(y, vbPixels, vbCentimeters), 1) & " cm"
End Sub
...
Private Sub cjEdt_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If cjEdt.objSelectedIndex > 0 Then
        stBar.Panels("Obj").Text = "物件名稱: " & cjEdt.objSelectedObject.Name
...
Private Sub mnuAbout_Click()
    MsgBox "撰寫作者：黃昭仁" & vbCrLf & _
            "軟體版本：" & App.Major & "." & App.Minor & "." & App.Revision & vbCrLf & _
            "版權所有：http://www.cj.idv.tw" & vbCrLf & _
            "釋出日期：" & "24-Aug-2005"
End Sub
...
Private Sub mnuBackgroundPic_Click()
    On Error Resume Next
    Dlg.Filter = "所有圖檔 (*.bmp;*.ico;*.wmf;*.jpg;*.gif)|*.bmp;*.ico;*.wmf;*.jpg;*.gif|點陣圖 (*.bmp)|*.bmp|圖示文件(*.ico)|*.ico|中繼檔 (*.wmf)|.wmf|Jpeg檔 (*.jpg)|*.jpg|Gif檔 (*.gif)|*.gif"
    Dlg.ShowOpen
...
Private Sub mnuGridScale_Click()
    cjEdt.GridScale = InputBox("請輸入定位點大小", , cjEdt.GridScale)
End Sub
...
On Error GoTo Err_tblObj_ButtonClick
    ...
    Select Case Button.Key
        ...
        Case "RoundAngel"
            If cjEdt.objRoundAngel > 0 Then cjEdt.objRoundAngel = InputBox("請輸入圓角的度數：", , cjEdt.objRoundAngel)
        Case "Ellipse"
        ...
        Case "BorderColor"
            ...
            On Error GoTo Err_tblObj_ButtonClick
        Case "BorderWidth"
            cjEdt.objBorderWidth = InputBox("請輸入框線的寬度：", , cjEdt.objBorderWidth)
        Case "BackColor"
            On Error Resume Next
            Dlg.ShowColor
